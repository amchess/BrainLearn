...
using namespace Brainlearn::WDLModel;
...
uint8_t Brainlearn::WDLModel::get_win_probability_by_material(const Value value,
...
uint8_t Brainlearn::WDLModel::get_win_probability(const Value value, const Position& pos) {
...
uint8_t Brainlearn::WDLModel::get_win_probability(const Value value, const int plies) {
