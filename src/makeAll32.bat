...
ren brainlearn.exe "BrainlearnSantiago-x86-32.exe"

Title "x86-32-old"
make clean
make -f MakeFile profile-build ARCH=x86-32-old COMP=mingw
strip brainlearn.exe
ren brainlearn.exe "BrainlearnSantiago-x86-32-old.exe"

Title "general-32"
make clean
make -f MakeFile profile-build ARCH=general-32 COMP=mingw
strip brainlearn.exe
ren brainlearn.exe "BrainlearnSantiago-general-32.exe"
