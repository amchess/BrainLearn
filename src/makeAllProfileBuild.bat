...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-64-ssse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-64-sse3-popcnt.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-64-sse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-ppc-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-general-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-32.exe"

Title "x86-32-old"
make clean
mingw32-make -f MakeFile profile-build ARCH=x86-32-old COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-x86-32-old.exe"

Title "ppc-32"
make clean
mingw32-make build ARCH=ppc-32 COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-ppc-32.exe"

Title "general-32"
make clean
mingw32-make -f MakeFile profile-build ARCH=general-32 COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.2-general-32.exe"
