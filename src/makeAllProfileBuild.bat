...
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.3-x86-32.exe"

Title "x86-32-old"
make clean
mingw32-make -f MakeFile profile-build ARCH=x86-32-old COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.3-x86-32-old.exe"

Title "general-32"
make clean
mingw32-make -f MakeFile profile-build ARCH=general-32 COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearn9.1.3-general-32.exe"
