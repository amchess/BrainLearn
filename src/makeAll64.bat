...
ren brainlearn.exe "BrainlearnSantiago-x86-64-vnni.exe"
...
strip brainlearn.exe
ren brainlearn.exe "BrainlearnSantiago-x86-64-bmi2.exe"

Title "x86-64-avx2"
make clean
mingw32-make profile-build ARCH=x86-64-avx2 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip brainlearn.exe
ren brainlearn.exe "BrainlearnSantiago-x86-64-avx2.exe"
...
strip brainlearn.exe
ren brainlearn.exe "BrainlearnSantiago-x86-64-ssse3.exe"
