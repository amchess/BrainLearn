...
strip stockfish.exe
ren stockfish.exe "BrainLearn16.1-x86-64-sse41-popcnt.exe"

Title "x86-64-ssse3"
make clean
mingw32-make profile-build ARCH=x86-64-ssse3 COMP=mingw CXX=x86_64-w64-mingw32-g++ -j %Number_Of_Processors%
strip stockfish.exe
ren stockfish.exe "BrainLearn16.1-x86-64-ssse3.exe"
