...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUELEARN1.0-x86-32.exe"

Title "x86-32-old"
make clean
mingw32-make -f MakeFile nnue-learn ARCH=x86-32-old COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUELEARN1.0-x86-32-old.exe"

Title "general-32"
make clean
mingw32-make -f MakeFile nnue-learn ARCH=general-32 COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUELEARN1.0-general-32.exe"
