...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-64-ssse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-64-sse3-popcnt.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-64-sse3.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-ppc-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-general-64.exe"
ren C:\MinGW\mingw64 mingw64-730-pse
...
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-32.exe"

Title "x86-32-old"
make clean
mingw32-make -f MakeFile profile-nnue ARCH=x86-32-old COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-x86-32-old.exe"

Title "general-32"
make clean
mingw32-make -f MakeFile profile-nnue ARCH=general-32 COMP=mingw
strip stockfish.exe
ren stockfish.exe "BrainLearnNNUE1.0-general-32.exe"
